...
public class Assert {
  ...
  public static AssertionFailedError fail(Object... messageParts) {
    ...
    Logger.instance().fail(new AssertionFailedError(message));
    throw new RuntimeException("Logger.fail(Throwable) wrong implemented");
  }
  
  public static AssertionFailedError fail(Throwable t) {
    Logger.instance().fail(new AssertionFailedError(t));
    throw new RuntimeException("Logger.fail(Throwable) wrong implemented");
  }
  ...
  public static void log(String string) {
    Logger.instance().logInfo(string);
  }
